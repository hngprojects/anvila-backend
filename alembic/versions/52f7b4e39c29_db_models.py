...
def upgrade() -> None:
    ...
    op.create_index('ix_refresh_tokens_expires_at_not_revoked', 'refresh_tokens', ['expires_at'], unique=False, postgresql_where=sa.text('revoked = false'))
    op.create_index(op.f('ix_refresh_tokens_token_hash'), 'refresh_tokens', ['token_hash'], unique=True)
    op.create_index(op.f('ix_refresh_tokens_user_id'), 'refresh_tokens', ['user_id'], unique=False)
    op.create_table('persona_skills',
...
def downgrade() -> None:
    ...
    op.drop_index('ix_refresh_tokens_expires_at_not_revoked', table_name='refresh_tokens', postgresql_where=sa.text('revoked = false'))
